...
fn test_memory_operations() {
    ...
    let _remember = Instruction::Remember {
        store_idx: payload as u16,
        src: 0,
    };
    let _forget = Instruction::Forget {
        store_idx: payload as u16,
        src: 0,
    };
    let _recall = Instruction::Recall {
        store_idx: payload as u16,
        src: 0,
        dst: 0,
    };
...
fn test_tvar_operations() {
    ...
    let _new_call = Instruction::Call {
        dst: 0,
        payload_idx: payload_new,
        first_arg: 0,
        arg_count: 0,
    };
    ...
    let _read_call = Instruction::Call {
        dst: 0,
        payload_idx: payload_read,
        first_arg: 0,
        arg_count: 0,
    };
    ...
    let _write_call = Instruction::Call {
        dst: 0,
        payload_idx: payload_write,
        first_arg: 0,
        arg_count: 0,
    };
}
...
fn test_option_operations() {
    ...
    let _some_call = Instruction::Call {
        dst: 0,
        payload_idx: payload_some,
        first_arg: 0,
        arg_count: 0,
    };
    ...
    let _is_some_call = Instruction::Call {
        dst: 0,
        payload_idx: payload_is_some,
        first_arg: 0,
        arg_count: 0,
    };
    ...
    let _is_none_call = Instruction::Call {
        dst: 0,
        payload_idx: payload_is_none,
        first_arg: 0,
        arg_count: 0,
    };
}
...
fn test_result_operations() {
    ...
    let _err_call = Instruction::Call {
        dst: 0,
        payload_idx: payload_err,
        first_arg: 0,
        arg_count: 0,
    };
    ...
    let _is_ok_call = Instruction::Call {
        dst: 0,
        payload_idx: payload_is_ok,
        first_arg: 0,
        arg_count: 0,
    };
    ...
    let _is_err_call = Instruction::Call {
        dst: 0,
        payload_idx: payload_is_err,
        first_arg: 0,
        arg_count: 0,
    };
    ...
    let _unwrap_or_call = Instruction::Call {
        dst: 0,
        payload_idx: payload_unwrap_or,
        first_arg: 0,
        arg_count: 0,
    };
}
...
fn test_len_operations() {
    ...
    let _len_call = Instruction::Call {
        dst: 0,
...
fn test_relation_operations() {
    ...
    let _decl = Instruction::DeclStore {
        payload_idx: decl_payload as u16,
        src: 0,
    };

    let sym_get = SymId(intern("get_relation").0);
    let payload_get = bytecode.add_call_payload(sym_get, 1) as u16;
    let _get_call = Instruction::Call {
        dst: 0,
        payload_idx: payload_get,
        first_arg: 0,
        arg_count: 0,
    };
    ...
    let _update_call = Instruction::Call {
        dst: 0,
        payload_idx: payload_update,
        first_arg: 0,
        arg_count: 0,
    };
    ...
    let _enforce_call = Instruction::Call {
        dst: 0,
        payload_idx: payload_enforce,
        first_arg: 0,
        arg_count: 0,
    };
}
...
fn test_constitution_operations() {
    ...
    let _register = Instruction::Call {
        dst: 0,
        payload_idx: payload_register,
        first_arg: 0,
        arg_count: 0,
    };
    ...
    let _activate = Instruction::Call {
        dst: 0,
        payload_idx: payload_activate,
        first_arg: 0,
        arg_count: 0,
    };
    ...
    let _deactivate = Instruction::Call {
        dst: 0,
        payload_idx: payload_deactivate,
        first_arg: 0,
        arg_count: 0,
    };
    ...
    let _check = Instruction::Call {
        dst: 0,
        payload_idx: payload_check,
        first_arg: 0,
        arg_count: 0,
    };
}
...
fn test_mcp_operations() {
    ...
    let payload = bytecode.add_call_payload(sym, 1) as u16;
    let _mcp_call = Instruction::Call {
        dst: 0,
        payload_idx: payload as u16,
        first_arg: 0,
        arg_count: 0,
...
fn test_object_creation() {
    let fields = HashMap::<hudhudscript_bytecode::sym::SymId, Value16>::new();
