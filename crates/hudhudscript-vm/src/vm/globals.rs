...
impl VM {
    pub(crate) fn register_globals(&mut self) {
        ...
        self.set_global("this", Value16::object(HashMap::new()));
        ...
        self.set_global("Math", Value16::object(math_obj));

        // JSON object (marker for method dispatch)
        let json_obj = HashMap::new();
        self.set_global("JSON", Value16::object(json_obj));
        ...
        let mut linalg_obj = HashMap::new();
        linalg_obj.insert(
            "__module".to_string(),
        ...
        let mut base64_obj = HashMap::new();
        base64_obj.insert(
            "__module".to_string(),
        ...
        let mut urlparser_obj = HashMap::new();
        ...
        let mut terminal_obj = HashMap::new();
        terminal_obj.insert(
            "__module".to_string(),
        ...
        let mut daemon_obj = HashMap::new();
        daemon_obj.insert(
            "__module".to_string(),
        ...
        let mut env_mod_obj = HashMap::new();
        ...
        let mut duration_obj = HashMap::new();
        duration_obj.insert(
            "__module".to_string(),
        ...
        let mut event_bus_obj = HashMap::new();
        ...
        let mut plugin_obj = HashMap::new();
        plugin_obj.insert(
            "__module".to_string(),
        ...
        let mut mcp_server_obj = HashMap::new();
        ...
        let mut plugin_config_obj = HashMap::new();
        ...
        let mut crypto_obj = HashMap::new();
        crypto_obj.insert(
            "__module".to_string(),
        ...
        let mut archive_obj = HashMap::new();
        archive_obj.insert(
            "__module".to_string(),
        ...
        let mut system_obj = HashMap::new();
        system_obj.insert(
            "__module".to_string(),
        ...
        let mut download_obj = HashMap::new();
        download_obj.insert(
            "__module".to_string(),
        ...
        let mut docker_obj = HashMap::new();
        docker_obj.insert(
            "__module".to_string(),
        ...
        let mut security_obj = HashMap::new();
        security_obj.insert(
            "__module".to_string(),
        ...
        let mut notify_obj = HashMap::new();
        notify_obj.insert(
            "__module".to_string(),
        ...
        let mut firewall_obj = HashMap::new();
        firewall_obj.insert(
            "__module".to_string(),
        ...
        let mut codesign_obj = HashMap::new();
        codesign_obj.insert(
            "__module".to_string(),
        ...
        let mut workflow_obj = HashMap::new();
        workflow_obj.insert(
            "__module".to_string(),
