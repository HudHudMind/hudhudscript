...
pub const VALIDATION_CUSTOM: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(310),
...
pub const VALIDATION_INVALID_FORMAT: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(311),
...
pub const VALIDATION_INVALID_LENGTH: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(312),
...
pub const VALIDATION_MISSING_REQUIRED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(313),
...
pub const VALIDATION_OUT_OF_RANGE: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(314),
...
pub const VALIDATION_PATTERN_MISMATCH: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(315),
...
pub const VALIDATION_REQUIRED_FIELD_MISSING: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(316),
...
pub const VALIDATION_TYPE_MISMATCH: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(317),
...
pub const VALIDATION_UNKNOWN_TYPE: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(318),
