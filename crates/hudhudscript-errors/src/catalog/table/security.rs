...
pub const SANDBOX_FILE_SYSTEM_DENIED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(255),
...
pub const SANDBOX_INVALID_CONFIG: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(256),
...
pub const SANDBOX_NETWORK_DENIED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(257),
...
pub const SANDBOX_PROCESS_DENIED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(258),
...
pub const SANDBOX_RESOURCE_LIMIT_EXCEEDED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(259),
...
pub const SANDBOX_SYSTEM_CALL_FAILED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(260),
