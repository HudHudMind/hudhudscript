...
pub const CYBERNETICS_ACTUATION_FAILED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(62),
...
Inspect the wrapped cause to determine whether the actuator endpoint is reachable, whether your value range is acceptable, and whether the loop can be safely resumed.",
        ...
        since_version: "0.4.5",
        category: ErrorCategory::Cybernetics,
    };

pub const CYBERNETICS_OBSERVER_ERROR: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(63),
...
pub const CYBERNETICS_POLICY_ERROR: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(64),
...
pub static ENTRIES: &[ErrorEntry] = &[
    CYBERNETICS_ACTUATION_FAILED,
    CYBERNETICS_OBSERVER_ERROR,
    CYBERNETICS_POLICY_ERROR,
];
