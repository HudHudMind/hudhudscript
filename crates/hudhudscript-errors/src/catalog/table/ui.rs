...
pub const BRIDGE_CONNECTION_LOST: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(11),
...
pub const BRIDGE_FRAMEWORK_ERROR: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(12),
...
pub const BRIDGE_INIT_FAILED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(13),
...
pub const BRIDGE_RENDER_FAILED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(14),
...
pub const BRIDGE_UNSUPPORTED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(15),
...
pub const DEPLOY_ADAPTER_ERROR: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(70),
...
pub const DEPLOY_BUILD_FAILED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(71),
...
pub const DEPLOY_CONFIG_ERROR: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(72),
...
pub const DEPLOY_DEPLOY_FAILED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(73),
...
pub const DEPLOY_ROLLBACK_FAILED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(74),
...
pub const NAVIGATION_BLOCKED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(145),
...
pub const NAVIGATION_NO_HISTORY: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(146),
...
pub const NAVIGATION_SCREEN_NOT_FOUND: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(147),
...
pub static ENTRIES: &[ErrorEntry] = &[
    ...
    BRIDGE_FRAMEWORK_ERROR,
    BRIDGE_INIT_FAILED,
    BRIDGE_RENDER_FAILED,
    BRIDGE_UNSUPPORTED,
    DEPLOY_ADAPTER_ERROR,
    DEPLOY_BUILD_FAILED,
    DEPLOY_CONFIG_ERROR,
    DEPLOY_DEPLOY_FAILED,
    DEPLOY_ROLLBACK_FAILED,
    NAVIGATION_BLOCKED,
    NAVIGATION_NO_HISTORY,
    NAVIGATION_SCREEN_NOT_FOUND,
];
