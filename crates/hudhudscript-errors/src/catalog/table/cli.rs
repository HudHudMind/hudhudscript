...
pub const ARG_INVALID_VALUE: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(3),
...
pub const ARG_MISSING_REQUIRED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(4),
...
pub const ARG_MISSING_SUBCOMMAND: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(5),
...
pub const ARG_OTHER: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(6),
...
pub const ARG_UNKNOWN_ARGUMENT: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(7),
...
pub static ENTRIES: &[ErrorEntry] = &[
    ...
    ARG_MISSING_SUBCOMMAND,
    ARG_OTHER,
    ARG_UNKNOWN_ARGUMENT,
];
