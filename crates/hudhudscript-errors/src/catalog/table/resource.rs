...
pub const REGISTRY_CALL_FAILED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(209),
...
pub const REGISTRY_DISCOVERY_FAILED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(210),
...
pub const REGISTRY_DUPLICATE_TOOL: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(211),
...
pub const REGISTRY_SERVER_NOT_FOUND: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(212),
...
pub const REGISTRY_TOOL_NOT_FOUND: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(213),
...
pub const REGISTRY_VALIDATION_FAILED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(214),
...
pub const RESOURCE_DISCOVERY_FAILED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(217),
...
pub const RESOURCE_INVALID_URI: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(218),
...
pub const RESOURCE_NOT_FOUND: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(219),
...
pub const RESOURCE_READ_FAILED: ErrorEntry =
    ErrorEntry {
        code: ErrorCode(220),
...
pub static ENTRIES: &[ErrorEntry] = &[
    REGISTRY_CALL_FAILED,
    REGISTRY_DISCOVERY_FAILED,
    REGISTRY_DUPLICATE_TOOL,
    REGISTRY_SERVER_NOT_FOUND,
