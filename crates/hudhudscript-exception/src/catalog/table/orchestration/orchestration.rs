...
pub const ORCHESTRATION_INVALID_WORKFLOW: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(159),
...
pub const ORCHESTRATION_LAYER_ERROR: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(160),
...
pub const ORCHESTRATION_NETWORK_ERROR: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(161),
...
pub const ORCHESTRATION_NETWORK_EXECUTION_FAILED: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(162),
...
pub const ORCHESTRATION_NETWORK_NOT_FOUND: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(163),
...
pub const ORCHESTRATION_WORKFLOW_ALREADY_EXISTS: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(164),
...
pub const ORCHESTRATION_WORKFLOW_NOT_FOUND: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(165),
...
pub const ORCHESTRATION_WORKFLOW_TIMED_OUT: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(166),
