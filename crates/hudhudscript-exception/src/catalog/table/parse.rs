...
Reducing the snippet around the highlighted region usually exposes the structural mistake quickly.",
        ...
        since_version: "0.1.0",
        category: ExceptionCategory::Parse,
    },

    ExceptionEntry {
        code: ExceptionCode(183),
