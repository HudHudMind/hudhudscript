...
pub const TABLE: [ExceptionEntry; 4] = [
    ExceptionEntry {
        code: ExceptionCode(193),
...
if !p.is_settled() {
    p.reject(\"timeout\");
        ...
        since_version: "0.4.0",
        category: ExceptionCategory::Promise,
    },

    ExceptionEntry {
        code: ExceptionCode(194),
