...
pub const TABLE: [ExceptionEntry; 8] = [
    ExceptionEntry {
        code: ExceptionCode(34),
...
This variant most often appears in early-stage feature work or when AST shapes from the parser do not match what the compiler expects.",
        ...
        category: ExceptionCategory::Compile,
    },

    ExceptionEntry {
        code: ExceptionCode(35),
