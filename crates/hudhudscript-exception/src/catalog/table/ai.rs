...
pub const TABLE: [ExceptionEntry; 18] = [
    ExceptionEntry {
        code: ExceptionCode(46),
...
c.send(\"hi\")?;"),
        ...
        since_version: "0.4.0",
        category: ExceptionCategory::Ai,
    },

    ExceptionEntry {
        code: ExceptionCode(47),
