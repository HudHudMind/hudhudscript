...
pub const TABLE: [ExceptionEntry; 11] = [
    ExceptionEntry {
        code: ExceptionCode(299),
...
atomically {
  account.balance = v;
        ...
        since_version: "0.4.0",
        category: ExceptionCategory::Type,
    },

    ExceptionEntry {
        code: ExceptionCode(300),
