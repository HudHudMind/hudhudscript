...
native_call(\"add\", 1, 2, 3) // 3 args, expected 2"),
        ...
        category: ExceptionCategory::Native,
    },

    ExceptionEntry {
        code: ExceptionCode(136),
