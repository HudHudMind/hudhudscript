...
pub const MODULE_LOADER_ALREADY_LOADED: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(131),
...
pub const MODULE_LOADER_MODULE_NOT_FOUND: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(132),
...
pub const MODULE_LOADER_PARSE_ERROR: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(133),
...
pub const MODULE_LOADER_READ_ERROR: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(134),
