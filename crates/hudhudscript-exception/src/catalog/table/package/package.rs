...
pub const PACKAGE_BUILD_FAILED: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(167),
...
pub const PACKAGE_CHECKSUM_MISMATCH: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(168),
...
pub const PACKAGE_DEPENDENCY_RESOLUTION: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(169),
...
pub const PACKAGE_ENTRY_POINT_NOT_FOUND: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(170),
...
pub const PACKAGE_INVALID_PACKAGE_NAME: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(171),
...
pub const PACKAGE_INVALID_VERSION: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(172),
...
pub const PACKAGE_IO: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(173),
...
pub const PACKAGE_NETWORK: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(174),
...
pub const PACKAGE_OTHER: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(175),
...
pub const PACKAGE_PACKAGE_NOT_FOUND: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(176),
...
pub const PACKAGE_SECURITY_VULNERABILITY: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(177),
...
pub const PACKAGE_SERIALIZATION: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(178),
...
pub const PACKAGE_TOML: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(179),
...
pub const PACKAGE_TOML_SERIALIZE: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(180),
...
pub const PACKAGE_VERSION_NOT_FOUND: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(181),
