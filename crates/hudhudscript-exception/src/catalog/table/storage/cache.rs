...
pub const CACHE_CONSTITUTION_NOT_FOUND: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(16),
...
pub const CACHE_DESERIALIZATION_ERROR: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(17),
...
pub const CACHE_DUPLICATE_CONTENT: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(18),
...
pub const CACHE_ID_COLLISION: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(19),
...
pub const CACHE_LAW_NOT_FOUND: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(20),
...
pub const CACHE_QUOTA_EXCEEDED: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(21),
...
pub const CACHE_RULE_NOT_FOUND: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(22),
...
pub const CACHE_SERIALIZATION_ERROR: ExceptionEntry =
    ExceptionEntry {
        code: ExceptionCode(23),
