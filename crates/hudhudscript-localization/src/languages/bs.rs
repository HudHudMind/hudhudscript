//! Bosnian keyword mappings (Latin)
//! Bosanski - Bosnian language support
...
pub fn get_keywords() -> HashMap<String, Keyword> {
    ...
    map.insert("tačno".to_string(), Keyword::True);
    map.insert("netačno".to_string(), Keyword::False);
    ...
    map.insert("provajder".to_string(), Keyword::Provider);
    ...
    map.insert("saradnički".to_string(), Keyword::Collaborative);
    ...
    map.insert("tužilac".to_string(), Keyword::Prosecutor);
    ...
    map.insert("zavisi_od".to_string(), Keyword::DependsOn);
    ...
    map.insert("dozvoli".to_string(), Keyword::Allow);
    ...
    map.insert("izvršilac".to_string(), Keyword::Executor);
    ...
    map.insert("mašina_stanja".to_string(), Keyword::StateMachine);
    map.insert("tehničko".to_string(), Keyword::Technical);
    map.insert("transformisati".to_string(), Keyword::Transform);
